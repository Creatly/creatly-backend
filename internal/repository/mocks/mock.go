...
func (m *MockCourses) Update(ctx context.Context, schoolId primitive.ObjectID, inp repository.UpdateCourseInput) error {
	m.ctrl.T.Helper()
...
func (m *MockModules) AddLesson(ctx context.Context, id primitive.ObjectID, lesson domain.Lesson) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddLesson", ctx, id, lesson)
	ret0, _ := ret[0].(error)
	return ret0
}

// AddLesson indicates an expected call of AddLesson.
func (mr *MockModulesMockRecorder) AddLesson(ctx, id, lesson interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AddLesson", reflect.TypeOf((*MockModules)(nil).AddLesson), ctx, id, lesson)
}

// AttachPackage mocks base method.
func (m *MockModules) AttachPackage(ctx context.Context, modules []primitive.ObjectID, packageId primitive.ObjectID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AttachPackage", ctx, modules, packageId)
	ret0, _ := ret[0].(error)
	return ret0
}

// AttachPackage indicates an expected call of AttachPackage.
func (mr *MockModulesMockRecorder) AttachPackage(ctx, modules, packageId interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AttachPackage", reflect.TypeOf((*MockModules)(nil).AttachPackage), ctx, modules, packageId)
}
...
func (m *MockLessonContent) DeleteContent(ctx context.Context, lessonIds []primitive.ObjectID) error {
	m.ctrl.T.Helper()
...
func (mr *MockLessonContentMockRecorder) DeleteContent(ctx, lessonIds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteContent", reflect.TypeOf((*MockLessonContent)(nil).DeleteContent), ctx, lessonIds)
}
...
// Update mocks base method.
func (m *MockLessonContent) Update(ctx context.Context, lessonId primitive.ObjectID, content string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Update", ctx, lessonId, content)
	ret0, _ := ret[0].(error)
	return ret0
}

// Update indicates an expected call of Update.
func (mr *MockLessonContentMockRecorder) Update(ctx, lessonId, content interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Update", reflect.TypeOf((*MockLessonContent)(nil).Update), ctx, lessonId, content)
}
